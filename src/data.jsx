...
export const DEALER_DIRECTORY_DATA = [
    ...
    { id: 8, name: 'Braden Business Systems', address: '777 Systems Way, Fishers, IN 46037', bookings: 210000, sales: 205000, salespeople: [{ name: 'Jason Beehler', status: 'active' }], designers: [{ name: 'Jen Franklin', status: 'active' }], administration: [], installers: [], recentOrders: [], dailyDiscount: '50/20 (60.00%)' },
    { id: 9, name: 'Schroeder\'s', address: '888 Office Park, Fort Wayne, IN 46805', bookings: 150000, sales: 140000, salespeople: [{ name: 'Andrea Kirkland', status: 'active' }], designers: [], administration: [], installers: [], recentOrders: [], dailyDiscount: '50/20 (60.00%)' },
    { id: 10, name: 'CVC', address: '999 Corporate Dr, Evansville, IN 47715', bookings: 230000, sales: 220000, salespeople: [{ name: 'Michael Jones', status: 'active' }], designers: [], administration: [{ name: 'Luke Miller', status: 'active' }], installers: [], recentOrders: [], dailyDiscount: '50/20 (60.00%)' },
