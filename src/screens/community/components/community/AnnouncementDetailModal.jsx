      ...
      >
        ...
        >
          ...
          <div className="px-5 pt-5 pb-3">
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[0.6875rem] font-semibold uppercase tracking-[0.07em]" style={{ color }}>{announcement.category?.replace('-', ' ')}</p>
                  {formattedDate && (
          ...
          <div className="px-5 pb-4 space-y-3">
            ...
            {announcement.text && (
              <p className="text-[0.8125rem] leading-relaxed" style={{ color: theme.colors.textSecondary }}>{announcement.text}</p>
            )}
            {announcement.image && (
