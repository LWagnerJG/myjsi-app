...
export const NewLeadScreen = ({
    ...
    return (
        <form onSubmit={handleSubmit} className="lead-form-inline flex flex-col h-full overflow-y-auto scrollbar-hide pt-[76px]" style={{ backgroundColor: theme.colors.background }}>
