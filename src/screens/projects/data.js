...
export const INITIAL_OPPORTUNITIES = [
  { id: 1, name: 'New Office Furnishings', stage: 'Discovery', discount: '50/20/5 (62.00%)', value: '$50,000', company: 'ABC Corporation', contact: 'John Smith', poTimeframe: '30-60 days', vertical: 'Corporate', winProbability: 50, competitionPresent: true, competitors: ['Steelcase','Haworth'], designFirms: ['McGee Designhouse'], dealers: ['Business Furniture'], products: [{series:'Vision'},{series:'Finn'}], notes: 'Main HQ expansion; awaiting test fit.' },
  ...
  { id: 2, name: 'Lobby Refresh', stage: 'Specifying', discount: '50/20/8 (63.20%)', value: '$75,000', company: 'XYZ Industries', contact: 'Jane Doe', poTimeframe: '60-90 days', vertical: 'Corporate', winProbability: 65, competitionPresent: true, competitors: ['MillerKnoll'], designFirms: ['CSO'], dealers: ['Business Furniture'], products: [{series:'Vision'},{series:'Wink'}], notes: 'Renderings complete; awaiting final budget approval.' }
];
