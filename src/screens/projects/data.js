...
export const EMPTY_LEAD = { project: '', designFirm: '', dealer: '', winProbability: 50, projectStatus: '', vertical: '', otherVertical: '', estimatedList: '', poTimeframe: '', competitors: [], otherCompetitor: '', competitionPresent: false, isBid: false, jsiSpecServices: false, quoteType: 'New Quote', pastProjectRef: '', discount: '', salesReward: true, designerReward: true, products: [], notes: '', jsiQuoteExists: false, jsiQuoteNumber: '', isContract: false, contractType: '' };
