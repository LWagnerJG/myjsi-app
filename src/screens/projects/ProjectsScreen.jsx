...
const OpportunityDetail = ({ opp, theme, onBack, onUpdate }) => {
  ...
  return (
    <div className="flex flex-col h-full pt-[64px]" style={{ background: theme.colors.background }}>
...
const InstallationDetail = ({ project, theme, onAddPhotoFiles }) => {
  ...
  return (
    <div className="flex flex-col h-full pt-[64px]" style={{ backgroundColor: theme.colors.background }}>
...
export const ProjectsScreen = forwardRef(({ onNavigate, theme, opportunities, setOpportunities, myProjects, setMyProjects, projectsInitialTab, clearProjectsInitialTab }, ref) => {
  ...
  return (
    <div className="h-full flex flex-col pt-[64px]" style={{ backgroundColor: theme.colors.background }}>
