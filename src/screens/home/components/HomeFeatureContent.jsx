                        ...
                        >
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    {post.timeAgo && (
                                        <div className="text-xs mt-1 opacity-50" style={{ color: colors.textSecondary }}>
                                            {post.timeAgo}
                                        </div>
                                    )}
                                </div>
                    ...
                    leadTimeFavoritesData.map((item) => (
                        ...
                        >
                            <div className="text-left">
                                ...
                                <div className="text-xs uppercase tracking-widest opacity-60" style={{ color: colors.textSecondary }}>{item.type}</div>
                            </div>
    ...
    if (mode === 'marketplace') {
        ...
        return (
            <div className="space-y-2">
                ...
                >
                    <div className="text-left">
                        <div className="text-xs uppercase tracking-widest" style={{ color: colors.textSecondary, opacity: 0.6 }}>Available balance</div>
            ...
            {recentOrders.map((order, i) => {
                ...
                >
                    ...
                    <div className="text-right flex-shrink-0">
                        ...
                        <div className="text-xs font-medium" style={{ color: statusColor }}>{order.status}</div>
                    </div>
                </button>
                );
            })}
