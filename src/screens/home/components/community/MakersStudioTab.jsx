      ...
      <GlassCard theme={theme} className="p-6 sm:p-8" variant="elevated">
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.15em]" style={{ color: theme.colors.textSecondary }}>
              JSI Makers Studio
            </span>
        ...
        {STATS.map((s, i) => (
          <GlassCard key={s.label} theme={theme} className="p-4 text-center" variant="elevated">
            <div style={{
              ...
              <div className="text-xs font-semibold uppercase tracking-wider mt-0.5" style={{ color: theme.colors.textSecondary, opacity: 0.5 }}>{s.label}</div>
            </div>
          </GlassCard>
        ))}
      </div>
                      ...
                      {pillar.courses.map((c) => (
                        <button key={c.title} className="w-full flex items-center justify-between py-2.5 px-3.5 rounded-xl transition-all active:scale-[0.99] text-left group"
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="text-xs font-medium mt-0.5" style={{ color: theme.colors.textSecondary, opacity: 0.5 }}>{c.tag}</div>
                          </div>
