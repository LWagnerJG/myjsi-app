          ...
          <div className="h-9 flex items-center">
            {inSubCommunity ? (
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[0.9375rem] font-bold" style={{ color: theme.colors.textPrimary }}>{activeSubreddit?.name}</span>
                {activeSubreddit?.members && (
                  <span className="text-[0.6875rem]" style={{ color: theme.colors.textSecondary, opacity: 0.5 }}>{activeSubreddit.members}</span>
                )}
              </div>
            ) : (
              /* Tab chip pills */
