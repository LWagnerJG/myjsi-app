        ...
        {products.map((p) => {
          ...
          return (
            ...
            >
              ...
              <span
                className="mt-1.5 text-[13px] font-medium tracking-tight text-center leading-tight line-clamp-1 w-full px-1 transition-colors"
      ...
      <div className="absolute left-0 right-0 bottom-0 px-4 pb-4 pt-12 flex items-end justify-between">
        <div className="leading-tight select-none">
          <AnimatePresence mode="wait">
            <motion.h2
              key={product.name}
              className="text-[26px] font-bold text-white drop-shadow-md tracking-tight"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
          ...
          <AnimatePresence mode="wait">
            <motion.p
              key={product.price}
              className="mt-0.5 text-[15px] font-semibold text-white/90 drop-shadow-sm"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 rounded-full font-medium text-[13px] transition-all active:scale-95 hover:scale-[1.03]"
          style={{
    ...
    <div className="space-y-3">
      ...
      >
        ...
        <div className="px-5 pt-4 pb-2 flex items-center justify-between">
          <span className="text-[11px] font-medium tracking-widest uppercase" style={{ color: theme.colors.textSecondary, opacity: 0.6 }}>
            Series
          </span>
          <span className="text-[11px] font-medium tracking-widest uppercase" style={{ color: theme.colors.textSecondary, opacity: 0.6 }}>
            List
