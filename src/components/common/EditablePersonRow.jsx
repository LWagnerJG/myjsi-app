        ...
        >
            ...
            {isEditing && (
                <div className="flex items-center space-x-2 animate-fade-in w-full mt-2">
                    ...
                    />
                    <button onClick={() => onRemovePerson(person.name)} className="p-2 rounded-full hover:bg-black/5 dark:hover:bg-white/5 dark:hover:bg-white/5 transition-colors" style={{ color: theme.colors.error }} aria-label={`Remove ${person.name}`}>
