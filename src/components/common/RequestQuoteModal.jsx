...
const SectionLabel = ({ children, accent }) => (
    <span className="text-[10px] font-bold uppercase tracking-[0.08em] block mb-1.5"
...
const SelectPill = ({ on, onClick, children, accent, accentText, textSecondary, isDark }) => (
    <button type="button" onClick={onClick}
        className="px-3.5 py-[7px] rounded-full text-[11px] font-semibold transition-all active:scale-[0.97]"
        style={{
        ...
        {options.map(opt => {
            ...
            return (
                <button key={opt.value} type="button" onClick={() => onChange(opt.value)}
                    className="relative flex-1 rounded-full py-[7px] text-[11px] font-semibold transition-colors whitespace-nowrap"
...
export const RequestQuoteModal = ({ show, onClose, theme, onSubmit, members = INITIAL_MEMBERS, initialData, currentUserId = 1 }) => {
    ...
    const inputStyle = {
        ...
        color: c.textPrimary, padding: '0 12px', fontSize: 12, fontWeight: 500,
            ...
            >
                ...
                >
                    ...
                    <div className="flex items-center justify-between px-5 py-4 flex-shrink-0"
                        ...
                        <h2 className="text-[15px] font-bold tracking-tight" style={{ color: c.textPrimary }}>
                            Request Quote
                        </h2>
                    ...
                    <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto scrollbar-hide">
                        <div className="px-5 py-4 space-y-4">
                            ...
                            <div>
                                ...
                                {errors.projectName && <p className="mt-1 text-[10px] font-semibold" style={{ color: c.error || '#B85C5C' }}>{errors.projectName}</p>}
                            </div>
                                ...
                                {formData.quoteType === 'revision' && (
                                    <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }}
                                        ...
                                        <div>
                                            ...
                                            {errors.previousQuoteRef && <p className="mt-1 text-[10px] font-semibold" style={{ color: c.error || '#B85C5C' }}>{errors.previousQuoteRef}</p>}
                                        </div>
                                    </motion.div>
                                )}
                            </AnimatePresence>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    {errors.dealerName && <p className="mt-1 text-[10px] font-semibold" style={{ color: c.error || '#B85C5C' }}>{errors.dealerName}</p>}
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <textarea value={formData.projectInfo}
                                    ...
                                    rows={2}
                                    className="w-full resize-none outline-none text-[12px] leading-relaxed"
                            ...
                            <div>
                                ...
                                <button type="button"
                                    ...
                                    <span className="text-[11px] font-semibold">Click to upload files</span>
                    ...
                    <div className="flex items-center justify-end gap-2.5 px-5 py-3.5 flex-shrink-0"
                        ...
                        <button type="submit" disabled={isSubmitting}
                            ...
                            className="px-5 py-2.5 rounded-full text-[12px] font-bold transition-all active:scale-[0.98] disabled:opacity-50 flex items-center gap-2"
