...
export const STATUS_COLORS = {
    [AVAILABILITY_STATUS.AVAILABLE]: 'bg-green-100 text-green-800',
    [AVAILABILITY_STATUS.RESERVED]: 'bg-yellow-100 text-yellow-800',
    [AVAILABILITY_STATUS.OUT_FOR_LOAN]: 'bg-blue-100 text-blue-800',
    [AVAILABILITY_STATUS.MAINTENANCE]: 'bg-red-100 text-red-800'
};
